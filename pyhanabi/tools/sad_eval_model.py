...
if __name__ == "__main__":
    ...
    parser.add_argument("--sad", default=True, type=bool)
    ...
    if args.paper == "sad":
        ...
        agents = sad_utils.load_sad_model(weight_files, args.device)
    elif args.paper == "op":
        agents = sad_utils.load_op_model(
                args.method, args.idx1, args.idx2, args.device)
