...
from sad_create import ActGroup
...
if __name__ == "__main__":
    ...
    explore_eps = sad_utils.generate_explore_eps(
    ...
    agent = sad_r2d2.SADAgent(
        ...
        args.eta,
        args.train_device,
        games[0].feature_size(args.sad)[0],
        args.rnn_hid_dim,
        games[0].num_action(),
        args.num_lstm_layer,
        args.hand_size,
    ...
    if args.load_model:
        ...
        sad_utils.load_weight(agent.online_net, args.load_model, args.train_device)
        print("*****done*****")
    ...
    tachometer = sad_utils.Tachometer()
