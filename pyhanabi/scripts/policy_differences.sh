...
python policy_differences.py \
    --act_policy1 ../training_models/sad_2p_models/sad_1.pthw \
    --act_policy2 ../training_models/sad_2p_models/sad_1.pthw \
    --act_sad_legacy 1,1 \
    --base_name sad \
    --comp_policy1 ../training_models/sad_2p_models/sad_2.pthw \
    --comp_policy2 ../training_models/sad_2p_models/sad_2.pthw \
    --comp_sad_legacy 1,1 \
    --comp_names sad \
    --num_game 1 \
    --num_thread 1 \
