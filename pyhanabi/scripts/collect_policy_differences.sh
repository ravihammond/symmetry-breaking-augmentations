...
#for split_indexes in $(seq 5 9)
#do
    #for single_policy_index in $(seq 0 5)
    #do
        #python tools/collect_policy_differences.py \
            #--output_dir acting_comp_train \
            #--rollout_policies agent_groups/all_sad.json \
            #--train_test_splits train_test_splits/sad_splits_six.json \
            #--split_indexes $split_indexes \
            #--single_policy $single_policy_index \
...
#for split_indexes in $(seq 1 12)
#do
    #for single_policy_index in $(seq 0 11)
    #do
        #python tools/collect_policy_differences.py \
            #--output_dir acting_comp_one_test \
            #--rollout_policies agent_groups/all_sad.json \
...
#do
    ...
    #do
        #python tools/collect_policy_differences.py \
            #--output_dir acting_comp_one_train \
            #--rollout_policies agent_groups/all_sad.json \
            #--train_test_splits train_test_splits/sad_splits_one.json \
            #--split_indexes $split_indexes \
            #--single_policy $single_policy_index \
...
do
    python tools/collect_policy_differences.py \
        --output_dir acting_comp_allobl_test \
        --rollout_policies agent_groups/all_sad.json \
        --train_test_splits train_test_splits/sad_splits_six.json \
        --split_indexes $split_indexes \
...
do
    ...
    do
        python tools/collect_policy_differences.py \
            --output_dir acting_comp_allobl_train \
            --rollout_policies agent_groups/all_sad.json \
            --train_test_splits train_test_splits/sad_splits_six.json \
            --split_indexes $split_indexes \
            --single_policy $single_policy_index \
...
do
    ...
    do
        python tools/collect_policy_differences.py \
            --output_dir acting_comp_allobl_one_test \
            --rollout_policies agent_groups/all_sad.json \
            --train_test_splits train_test_splits/sad_splits_one.json \
            --split_indexes $split_indexes \
            --single_policy $single_policy_index \
...
do
    ...
    do
        python tools/collect_policy_differences.py \
            --output_dir acting_comp_allobl_one_train \
            --rollout_policies agent_groups/all_sad.json \
            --train_test_splits train_test_splits/sad_splits_one.json \
            --split_indexes $split_indexes \
            --single_policy $single_policy_index \
...
#for single_policy_index in $(seq 7 12)
#do
    #python tools/collect_policy_differences.py \
        #--output_dir sad_similarities \
        #--rollout_policies agent_groups/all_sad.json \
        #--single_policy $single_policy_index \
        #--compare_models sad \
        #--num_game 5000 \
