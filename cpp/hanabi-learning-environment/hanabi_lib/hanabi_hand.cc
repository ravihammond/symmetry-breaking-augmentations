...
std::string HanabiHand::CardKnowledge::ToString() const {
    ...
    result += ColorKnowledgeRangeString() + RankKnowledgeRangeString();
    return result;
}

std::string HanabiHand::CardKnowledge::ColorKnowledgeRangeString() const {
    std::string result;
...
std::string HanabiHand::CardKnowledge::RankKnowledgeRangeString() const {
    std::string result;
